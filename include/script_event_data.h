...
typedef intern_t *(*key_ini_t)(intern_t *prev, general_data_t *gd);
...
//set
intern_t *ins_ini_set(intern_t *prev, general_data_t *gd);
...
//while
intern_t *ins_ini_while(intern_t *prev, general_data_t *gd);
